...
- EDA & mining JSON summaries: `reports/eda_results.json`, `reports/mining_results.json`
- Interactive dashboard HTML: `reports/glp1_dashboard.html`
- Auto-generated presentation: `reports/GLP1_FAERS_Presentation.pptx`
...
- The `python-pptx` generated slides include speaker notes to help your presentation.
